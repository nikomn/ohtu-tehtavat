...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.onkoJoLukujonossa(10));
        assertFalse(joukko.onkoJoLukujonossa(5));
        assertFalse(joukko.onkoJoLukujonossa(0));
        assertTrue(joukko.onkoJoLukujonossa(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.onkoJoLukujonossa(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.onkoJoLukujonossa(11));
        joukko.poista(11);
        assertFalse(joukko.onkoJoLukujonossa(11));
